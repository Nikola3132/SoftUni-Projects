namespace FestivalManager.Entities.Sets
{
	...
	public abstract class Set :ISet
	{
		...
		{
            //TODO Maybe we should check only the song.Duration > this.MaxDuration
		...
		public bool CanPerform()
		{
            ...
            //TODO Not sure what this Linq do!
            var allPerformersHaveInstruments = this.Performers.All(p => p.Instruments.Any(i => i.IsBroken == false));
            ...
            //TODO Not sure should we use this
