    ...
    public abstract class BaseVehicle : IVehicle
    {
        ...
        public int Attack
        {
            ...
            private set
            {
                if (value < 0)
                {
                    throw new ArgumentException(GlobalConstants.VehicleAttackCannotBeLessThanZero);
                }
        ...
        public int Defense
        {
            ...
            private set
            {
                if (value < 0)
                {
                    throw new ArgumentException(GlobalConstants.VehicleDefenseCannotBeLessThanZero);
                }
        ...
        public int HitPoints
        {
            ...
            private set
            {
                if (value < 0)
                {
                    throw new ArgumentException(GlobalConstants.VehicleHitPointsCannotBeLessThanZero);
                }
